# YimMenu Custom (For Extras Addon)

Source for compiling YimMenu without SET_ENTITY_AS_NO_LONGER_NEEDED() when spawning vehicles to allow gifting.
...
YimMenu is originally based off of [BigBaseV2](https://github.com/Pocakking/BigBaseV2) which was an amazing base at the time but nowadays is a bit dated.
